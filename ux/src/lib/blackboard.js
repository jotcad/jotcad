...
export const blackboard = {
  ...
  readSelector: vfsActions.readSelector.bind(vfsActions),
  readSelectorData: vfsActions.readSelectorData.bind(vfsActions),
  readCID: vfsActions.readCID.bind(vfsActions),
  readCIDData: vfsActions.readCIDData.bind(vfsActions),
