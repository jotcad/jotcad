...
export const DynamicUX = (props) => {
  ...
  createEffect(async () => {
    ...
    try {
      ...
      const jsText = await vfs.readData({ path, parameters: {} });
      ...
      console.log(
        `[DynamicUX] Received script (${
          jsText.length
        } chars). First 50: "${jsText.slice(0, 50)}..."`
      );
  ...
  return (
    <div class="w-full mt-3 border-t border-white/10 pt-3">
      <div class="flex items-center justify-between mb-2">
        ...
        <div
          class={`text-[7px] font-mono px-1.5 py-0.5 rounded border ${
            status() === 'ready'
      ...
      {error() ? (
        ...
        <div
          ref={containerRef}
          class="min-h-12 flex items-center justify-center text-white/30 text-[10px] italic"
        >
