...
async function runTest() {
    ...
    try {
        ...
        await page.goto('http://localhost:3031/test/triangle_render.html');
        ...
        await page.screenshot({ path: 'ux/test/triangle_snapshot.png' });
        console.log('[Puppeteer] Snapshot saved to ux/test/triangle_snapshot.png');
