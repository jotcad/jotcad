...
static std::vector<uint8_t> outline_op(jotcad::fs::VFSClient* vfs, const std::string& path, const nlohmann::json& params) {
    ...
    std::cout << "[Outline Op] Reading Shape from: " << src_path << " with params: " << src_params.dump() << std::endl;
    ...
    std::cout << "[Outline Op] Reading Mesh from: " << geo_path << std::endl;
