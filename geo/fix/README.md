...
* **[predicates.h](file:///home/brian/github/jotcad_ez/geo/fix/predicates.h)**: Exact Rational Geometric Predicates (`is_point_on_segment`, `is_point_in_triangle`): lightweight exact predicates built on native CGAL `do_intersect` in pure `EK::FT`.
