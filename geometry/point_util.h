...
static EK::FT compute_approximate_point_value(double value,
                                              double tolerance = 0.001) {
  return CGAL::simplest_rational_in_interval<EK::FT>(value - tolerance,
                                                     value + tolerance);
}

static EK::FT compute_approximate_point_value(EK::FT ft) {
