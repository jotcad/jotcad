#!/bin/bash
# Script to build, flash, and monitor the esp32cam_number_ocr application
...
echo "============================================================"
echo "  JotCAD Node: ESP32-CAM TensorFlow Lite Digit OCR Node"
echo "============================================================"
...
if DEVICE_NODE_ID="$NODE_ID" pio run -e esp32cam_number_ocr -t upload -t monitor; then
