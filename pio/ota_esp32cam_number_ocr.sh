#!/bin/bash
# Script to build and upload via OTA the esp32cam_number_ocr application
...
NODE_ID="esp32cam-number-ocr-$SUFFIX"
...
echo "============================================================"
echo "  JotCAD Node: ESP32-CAM Number OCR Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp32cam_number_ocr -t upload --upload-port "$IP_OR_HOST"; then
