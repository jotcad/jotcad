#!/bin/bash
# Script to build and upload via OTA the esp32_dual_music_synth application
...
echo "============================================================"
echo "  JotCAD Node: ESP32 Dual Music Synth (NimBLE-MIDI & ESP32Synth) (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp32_dual_music_synth -t upload --upload-port "$IP_OR_HOST"; then
