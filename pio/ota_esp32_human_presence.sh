#!/bin/bash
# Script to build and upload via OTA the esp32_human_presence application
...
echo "============================================================"
echo "  JotCAD Node: ESP32 Human Presence Sensor Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp32_human_presence -t upload --upload-port "$IP_OR_HOST"; then
