#!/bin/bash
# Script to build and upload via OTA the esp8266_human_presence application
...
NODE_ID="esp8266-human-presence-$SUFFIX"
...
echo "============================================================"
echo "  JotCAD Node: ESP8266 Human Presence Sensor Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp8266_human_presence -t upload --upload-port "$IP_OR_HOST"; then
