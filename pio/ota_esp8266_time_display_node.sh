#!/bin/bash
# Script to build and upload via OTA the esp8266_time_display application
...
echo "============================================================"
echo "  JotCAD Node: ESP8266 7-Segment Time Display Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp8266_time_display -t upload --upload-port "$IP_OR_HOST"; then
