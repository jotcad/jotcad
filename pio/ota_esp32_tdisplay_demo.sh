#!/bin/bash
# Script to build and upload via OTA the esp32_tdisplay_demo application
...
NODE_ID="esp32-tdisplay-demo-$SUFFIX"
...
echo "============================================================"
echo "  JotCAD Node: ESP32 Tenstar T-Display Demo Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp32_tdisplay_demo -t upload --upload-port "$IP_OR_HOST"; then
