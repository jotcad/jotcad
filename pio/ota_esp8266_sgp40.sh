#!/bin/bash
# Script to build and upload via OTA the esp8266_sgp40 application
...
echo "============================================================"
echo "  JotCAD Node: ESP8266 SGP40 Air Quality Sensor Node (OTA)"
echo "============================================================"
echo ""
echo "[JotCAD] Starting OTA Build and Upload for $NODE_ID to $IP_OR_HOST..."

if DEVICE_NODE_ID="$NODE_ID" pio run -e esp8266_sgp40 -t upload --upload-port "$IP_OR_HOST"; then
